...
Check the [releases](https://github.com/droboports/python-pycrypto/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/python-pycrypto.git
cd python-pycrypto
./build.sh
ls -la *.egg
```
